...
test(`sma data works`, async () => {
  const data = await alpha.technical.sma(`msft`, `daily`, 60, `close`);
...
test(`ema data works`, async () => {
  const data = await alpha.technical.ema(`msft`, `daily`, 60, `close`);
...
test(`wma data works`, async () => {
  const data = await alpha.technical.wma(`msft`, `daily`, 60, `close`);
...
test(`dema data works`, async () => {
  const data = await alpha.technical.dema(`msft`, `daily`, 60, `close`);
...
test(`tema data works`, async () => {
  const data = await alpha.technical.tema(`msft`, `daily`, 60, `close`);
...
test(`trima data works`, async () => {
  const data = await alpha.technical.trima(`msft`, `daily`, 60, `close`);
...
test(`kama data works`, async () => {
  const data = await alpha.technical.kama(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`mama data works`, async () => {
  const data = await alpha.technical.mama(`msft`, `daily`, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`t3 data works`, async () => {
  const data = await alpha.technical.t3(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`macd data works`, async () => {
  const data = await alpha.technical.macd(`msft`, `daily`, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`macdext data works`, async () => {
  const data = await alpha.technical.macdext(`msft`, `daily`, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`stoch data works`, async () => {
  const data = await alpha.technical.stoch(`msft`, `daily`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`stochf data works`, async () => {
  const data = await alpha.technical.stochf(`msft`, `daily`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`rsi data works`, async () => {
  const data = await alpha.technical.rsi(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`stochrsi data works`, async () => {
  const data = await alpha.technical.stochrsi(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`willr data works`, async () => {
//   const data = await alpha.technical.willr(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`adx data works`, async () => {
//   const data = await alpha.technical.adx(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`adxr data works`, async () => {
//   const data = await alpha.technical.adxr(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`apo data works`, async () => {
//   const data = await alpha.technical.apo(`msft`, `daily`, `close`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`ppo data works`, async () => {
//   const data = await alpha.technical.ppo(`msft`, `daily`, `close`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`mom data works`, async () => {
  const data = await alpha.technical.mom(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`bop data works`, async () => {
//   const data = await alpha.technical.bop(`msft`, `daily`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`cci data works`, async () => {
  const data = await alpha.technical.cci(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`cmo data works`, async () => {
  const data = await alpha.technical.cmo(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`roc data works`, async () => {
  const data = await alpha.technical.roc(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`rocr data works`, async () => {
  const data = await alpha.technical.rocr(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`aroon data works`, async () => {
//   const data = await alpha.technical.aroon(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`aroonosc data works`, async () => {
//   const data = await alpha.technical.aroonosc(`msft`, `daily`, 60))
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`mfi data works`, async () => {
//   const data = alpha.technical.mfi(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`trix data works`, async () => {
  const data = await alpha.technical.trix(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ultosc data works`, async () => {
  const data = await alpha.technical.ultosc(`msft`, `daily`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`dx data works`, async () => {
//   const data = await alpha.technical.dx(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`minus_di data works`, async () => {
//   const data = await alpha.technical.minus_di(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`plus_di data works`, async () => {
//   const data = await alpha.technical.plus_di(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`minus_dm data works`, async () => {
//   const data = await alpha.technical.minus_dm(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`plus_dm data works`, async () => {
//   const data = await alpha.technical.plus_dm(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`bbands data works`, async () => {
//   const data = await alpha.technical.bbands(`msft`, `daily`, 60, `close`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`midpoint data works`, async () => {
  const data = await alpha.technical.midpoint(`msft`, `daily`, 60, `close`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`midprice data works`, async () => {
//   const data = await alpha.technical.midprice(`msft`, `daily`, 60)
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`sar data works`, async () => {
  const data = await alpha.technical.sar(`msft`, `daily`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`trange data works`, async () => {
//   const data = await alpha.technical.trange(`msft`, `daily`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`atr data works`, async () => {
//   const data = await alpha.technical.atr(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`natr data works`, async () => {
//   const data = await alpha.technical.natr(`msft`, `daily`, 60);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`ad data works`, async () => {
//   const data = await alpha.technical.ad(`msft`, `daily`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`adosc data works`, async () => {
  const data = await alpha.technical.adosc(`msft`, `daily`);
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
// test(`obv data works`, async () => {
//   const data = await alpha.technical.obv(`msft`, `daily`);
//       expect(data["Meta Data"]).toBeDefined();
//       expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ht_trendline data works`, async () => {
  const data = await alpha.technical.ht_trendline(`msft`, `daily`, "close");
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ht_sine data works`, async () => {
  const data = await alpha.technical.ht_sine(`msft`, `daily`, "close");
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ht_trendmode data works`, async () => {
  const data = await alpha.technical.ht_trendmode(`msft`, `daily`, "close");
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ht_dcperiod data works`, async () => {
  const data = await alpha.technical.ht_dcperiod(`msft`, `daily`, "close");
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ht_dcphase data works`, async () => {
  const data = await alpha.technical.ht_dcphase(`msft`, `daily`, "close");
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
...
test(`ht_dcphasor data works`, async () => {
  const data = await alpha.technical.ht_dcphasor(`msft`, `daily`, "close");
  expect(data["Meta Data"]).toBeDefined();
  expect(data["Meta Data"]["1: Symbol"]).toEqual("msft");
